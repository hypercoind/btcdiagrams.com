  ...
  return (
    ...
    >
      ...
      <g transform="translate(25, 30)">
        <rect x="0" y="0" width="65" height="50" rx="4" className="fill-primary/20 stroke-primary" strokeWidth="2" />
        ...
        <text x="38" y="37" textAnchor="middle" className="fill-muted-foreground text-xs">Online</text>
      </g>

      {/* Cold wallet */}
      <g transform="translate(110, 30)">
        <rect x="0" y="0" width="65" height="50" rx="4" className="fill-secondary/20 stroke-secondary" strokeWidth="2" />
        ...
        <text x="38" y="37" textAnchor="middle" className="fill-muted-foreground text-xs">Offline</text>
      </g>
